...
| payload | ShipmentCompletedOutbound | No |  |
...
{
  "type": "record",
  "name": "ShipmentCompletedOutboundEvent",
  "namespace": "com.arcone.biopro.distribution.eventbridge.domain.event",
  "doc": "Event published when shipmentcompletedoutbound occurs",
  "fields": [
    {
      "name": "eventId",
      "type": {
    ...
    },
    {
      ...
      "type": "string",
      "doc": "Type of event",
      "default": "SHIPMENTCOMPLETEDOUTBOUND"
    },
    {
      "name": "eventVersion",
      "type": "string",
