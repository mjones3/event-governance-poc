...
name: StorageCreated
version: '1.0'
summary: Event published by storage service when storagecreated occurs
owners:
  - storage-service
producers:
  - storage-service
...
**Schema ID**: 132
**Schema Version**: 2
**Subject**: StorageCreatedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.storage.domain.event

## Business Context

Event published when storagecreated occurs
...
```json
{
  "eventId": "514cda95-57e6-4a82-a7e2-4e11bcfa81de",
  "occurredOn": 1763355987914,
  "occurredOnTimeZone": 1763355987914,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./StorageCreatedEvent.avsc) - Complete Avro schema definition
