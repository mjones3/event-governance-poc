...
name: ApheresisRBCProductUpdated
version: '1.0'
summary: Event published by apheresisrbc service when apheresis plasma product updated occurs
owners:
...
**Schema ID**: 111
**Schema Version**: 2
**Subject**: ApheresisRBCProductUpdatedEvent
...
```json
{
  "eventId": "27fb141d-154d-4921-b1b0-127bd379900f",
  "occurredOn": 1763355986955,
  "occurredOnTimeZone": 1763355986955,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./ApheresisRBCProductUpdatedEvent.avsc) - Complete Avro schema definition
