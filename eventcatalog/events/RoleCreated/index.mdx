...
name: RoleCreated
version: '1.0'
summary: Event published by role service when rolecreated occurs
owners:
  - role-service
producers:
  - role-service
...
```json
{
  "eventId": "6d813957-eaba-4adb-9dd9-8dfbc1b8c7de",
  "occurredOn": 1763348547542,
  "occurredOnTimeZone": 1763348547542,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
