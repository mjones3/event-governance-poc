...
name: PooledProductCreated
version: '1.0'
summary: Event published by pooling service when pooled product created occurs
owners:
  - pooling-service
producers:
  - pooling-service
...
**Schema ID**: 121
**Schema Version**: 2
**Subject**: PooledProductCreatedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.pooling.domain.event

## Business Context

Event published when pooled product created occurs
...
```json
{
  "eventId": "7f302273-cf49-47e4-922c-1de12a16cbec",
  "occurredOn": 1763355987635,
  "occurredOnTimeZone": 1763355987635,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./PooledProductCreatedEvent.avsc) - Complete Avro schema definition
