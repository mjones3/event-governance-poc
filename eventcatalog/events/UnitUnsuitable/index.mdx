...
name: UnitUnsuitable
version: '1.0'
summary: Event published by testresultmanagement service when unitunsuitable occurs
owners:
...
**Schema ID**: 123
**Schema Version**: 2
**Subject**: UnitUnsuitableEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.pooling.domain.event

## Business Context

Event published when unit unsuitable occurs
...
```json
{
  "eventId": "7635ddec-224e-4374-a93f-e31190e3902c",
  "occurredOn": 1763355988096,
  "occurredOnTimeZone": 1763355988096,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./UnitUnsuitableEvent.avsc) - Complete Avro schema definition
