...
version: '1.0'
summary: Event published by apheresisplatelet service when apheresis plasma product completed occurs
owners:
...
**Schema ID**: 97
**Schema Version**: 2
**Subject**: ApheresisPlateletProductCompletedEvent
...
```json
{
  "eventId": "4b113210-aec8-4675-90f4-0377701d595f",
  "occurredOn": 1763355986766,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./ApheresisPlateletProductCompletedEvent.avsc) - Complete Avro schema definition
