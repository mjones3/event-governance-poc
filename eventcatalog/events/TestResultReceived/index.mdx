...
version: '1.0'
summary: Event published by testresultmanagement service when testresultreceived occurs
owners:
...
**Schema ID**: 89
**Schema Version**: 1
**Subject**: TestResultReceivedEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when testresultreceived occurs
...
```json
{
  "eventId": "e9d166d6-15d7-44cd-90b7-a3d07bb6ef85",
  "occurredOn": 1763355988054,
  "eventType": "STANDARD",
  "eventVersion": "1.0",
...
- [Download Avro Schema](./TestResultReceivedEvent.avsc) - Complete Avro schema definition
