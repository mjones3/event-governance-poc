...
name: DonorNotificationCompleted
version: '1.0'
summary: Event published by notification service when donor notification completed occurs
owners:
...
**Schema ID**: 74
**Schema Version**: 1
**Subject**: DonorNotificationCompletedEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.notification.domain.event

## Business Context

Event published when donor notification completed occurs
...
```json
{
  "eventId": "70661ba6-fc2f-4090-b48f-8ac114ce1c2b",
  "occurredOn": 1763355987263,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./DonorNotificationCompletedEvent.avsc) - Complete Avro schema definition
