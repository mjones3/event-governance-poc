...
name: ApheresisPlateletSampleCollected
version: '1.0'
summary: Event published by apheresisplatelet service when apheresis platelet sample collected occurs
owners:
...
**Schema ID**: 102
**Schema Version**: 2
**Subject**: ApheresisPlateletSampleCollectedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.apheresisplatelet.domain.event

## Business Context

Event published when apheresis platelet sample collected occurs
...
```json
{
  "eventId": "84382ab1-b2a2-4214-ba08-564e92191861",
  "occurredOn": 1763355986871,
  "occurredOnTimeZone": 1763355986871
}
```
...
- [Download Avro Schema](./ApheresisPlateletSampleCollectedEvent.avsc) - Complete Avro schema definition
