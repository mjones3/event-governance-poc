...
version: '1.0'
summary: Event published by recoveredplasmashipping service when recoveredplasmacartonunpacked occurs
owners:
...
```json
{
  "eventId": "55d115cb-3ee4-41b2-9b1a-cc652add5509",
  "occurredOn": 1763348547418,
  "occurredOnTimeZone": 1763348547418,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
