...
name: WholeBloodSampleCollected
version: '1.0'
summary: Event published by wholeblood service when whole blood sample collected occurs
owners:
  - wholeblood-service
producers:
  - wholeblood-service
...
**Schema ID**: 138
**Schema Version**: 2
**Subject**: WholeBloodSampleCollectedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.wholeblood.domain.event

## Business Context

Event published when whole blood sample collected occurs
...
```json
{
  "eventId": "de14cfd8-d31c-45cf-b511-2a62108f8466",
  "occurredOn": 1763355988277,
  "occurredOnTimeZone": 1763355988277,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./WholeBloodSampleCollectedEvent.avsc) - Complete Avro schema definition
