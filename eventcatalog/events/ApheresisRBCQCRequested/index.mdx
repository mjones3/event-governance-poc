...
name: ApheresisRBCQCRequested
version: '1.0'
summary: Event published by apheresisrbc service when apheresis rbc qc requested occurs
owners:
...
**Schema ID**: 112
**Schema Version**: 2
**Subject**: ApheresisRBCQCRequestedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.apheresisrbc.domain.event

## Business Context

Event published when apheresis rbc qc requested occurs
...
```json
{
  "eventId": "3eec8b89-a892-41f6-b2fb-e821ed551e6b",
  "occurredOn": 1763355986977,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./ApheresisRBCQCRequestedEvent.avsc) - Complete Avro schema definition
