...
version: '1.0'
summary: Event published by recoveredplasmashipping service when recoveredplasmashipmentcreated occurs
owners:
...
```json
{
  "eventId": "0d30856f-7f92-4b07-84a4-b84e7fc1c163",
  "occurredOn": 1763348547540,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
