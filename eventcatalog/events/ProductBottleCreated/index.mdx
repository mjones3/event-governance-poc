...
name: ProductBottleCreated
version: '1.0'
summary: Event published by apheresisplatelet service when product bottle created occurs
owners:
...
**Schema ID**: 104
**Schema Version**: 2
**Subject**: ProductBottleCreatedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.apheresisplatelet.domain.event

## Business Context

Event published when product bottle created occurs
...
```json
{
  "eventId": "44c35608-b966-4c5f-bd90-8fe4e7a4bb17",
  "occurredOn": 1763355987677,
  "occurredOnTimeZone": 1763355987677,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./ProductBottleCreatedEvent.avsc) - Complete Avro schema definition
