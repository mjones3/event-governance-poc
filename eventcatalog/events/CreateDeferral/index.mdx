...
name: CreateDeferral
version: '1.0'
summary: Event published by testresultmanagement service when createdeferral occurs
owners:
...
**Schema ID**: 80
**Schema Version**: 1
**Subject**: CreateDeferralEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when createdeferral occurs
...
```json
{
  "eventId": "8fef4c7f-8106-46e0-8fe2-55cb43e94d83",
  "occurredOn": 1763355987176,
  "occurredOnTimeZone": 1763355987176,
  "eventType": "STANDARD",
  "eventVersion": "1.0",
...
- [Download Avro Schema](./CreateDeferralEvent.avsc) - Complete Avro schema definition
