...
name: PooledProductUpdated
version: '1.0'
summary: Event published by pooling service when pooled product updated occurs
owners:
  - pooling-service
producers:
  - pooling-service
...
**Schema ID**: 122
**Schema Version**: 2
**Subject**: PooledProductUpdatedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.pooling.domain.event

## Business Context

Event published when pooled product updated occurs
...
```json
{
  "eventId": "85dce46b-caae-4b33-9667-f80eece77c2a",
  "occurredOn": 1763355987656,
  "occurredOnTimeZone": 1763355987656,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./PooledProductUpdatedEvent.avsc) - Complete Avro schema definition
