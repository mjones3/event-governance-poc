...
name: BloodTypeReceived
version: '1.0'
summary: Event published by testresultmanagement service when bloodtypereceived occurs
owners:
...
**Schema ID**: 78
**Schema Version**: 1
**Subject**: BloodTypeReceivedEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when bloodtypereceived occurs
...
```json
{
  "eventId": "bf57d149-d68c-4223-a82e-a981eab17234",
  "occurredOn": 1763355987053,
  "occurredOnTimeZone": 1763355987053,
  "eventType": "STANDARD",
  "eventVersion": "1.0",
...
- [Download Avro Schema](./BloodTypeReceivedEvent.avsc) - Complete Avro schema definition
