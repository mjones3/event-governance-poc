...
name: AcceptedNewDonation
version: '1.0'
summary: Event published by collections service when acceptednewdonation occurs
owners:
  - collections-service
producers:
  - collections-service
...
**Schema ID**: 58
**Schema Version**: 1
**Subject**: AcceptedNewDonationEvent
**Domain**: Collections
**Namespace**: com.arcone.biopro.interfaces.collections.domain.event

## Business Context

Event published when acceptednewdonation occurs
...
```json
{
  "eventId": "a7b5df2d-3e6a-4655-a74b-3390c6f5bbfc",
  "occurredOn": 1763355986609,
  "occurredOnTimeZone": 1763355986609,
  "eventType": "STANDARD",
  "eventVersion": "1.0",
  "source": "source_value"
}
...
- [Download Avro Schema](./AcceptedNewDonationEvent.avsc) - Complete Avro schema definition
