...
name: CreateAboRhException
version: '1.0'
summary: Event published by testresultmanagement service when createaborhexception occurs
owners:
...
**Schema ID**: 79
**Schema Version**: 1
**Subject**: CreateAboRhExceptionEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when createaborhexception occurs
...
| `exception` | `string` | Yes | exception field |
...
```json
{
  "eventId": "02fa5970-0715-4228-b24a-869d91a18a75",
  "occurredOn": 1763355987152,
  "eventType": "STANDARD",
...
- [Download Avro Schema](./CreateAboRhExceptionEvent.avsc) - Complete Avro schema definition
