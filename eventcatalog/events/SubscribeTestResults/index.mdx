...
name: SubscribeTestResults
version: '1.0'
summary: Event published by research service when subscribetestresults occurs
owners:
  - research-service
producers:
  - research-service
...
**Schema ID**: 84
**Schema Version**: 1
**Subject**: SubscribeTestResultsEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when subscribetestresults occurs
...
```json
{
  "eventId": "0c27ce91-9ac5-4e32-acd4-2805ba101b12",
  "occurredOn": 1763355987934,
  "occurredOnTimeZone": 1763355987934,
  "eventVersion": "1.0",
...
- [Download Avro Schema](./SubscribeTestResultsEvent.avsc) - Complete Avro schema definition
