...
version: '1.0'
summary: Event published by irradiation service when productquarantined occurs
owners:
  - irradiation-service
producers:
  - irradiation-service
...
**Schema ID**: 67
**Schema Version**: 1
**Subject**: ProductQuarantinedEvent
**Domain**: Distribution
**Namespace**: com.arcone.biopro.distribution.irradiation.domain.event

## Business Context

Event published when productquarantined occurs
...
```json
{
  "eventId": "30927278-2864-49f2-ab1e-ac362274b67e",
  "occurredOn": 1763355987720,
  "occurredOnTimeZone": 1763355987720,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./ProductQuarantinedEvent.avsc) - Complete Avro schema definition
