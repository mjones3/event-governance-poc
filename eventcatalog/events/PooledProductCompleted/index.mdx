...
name: PooledProductCompleted
version: '1.0'
summary: Event published by pooling service when pooled product completed occurs
owners:
  - pooling-service
producers:
  - pooling-service
...
**Schema ID**: 120
**Schema Version**: 2
**Subject**: PooledProductCompletedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.pooling.domain.event

## Business Context

Event published when pooled product completed occurs
...
```json
{
  "eventId": "38b7858d-bb12-454a-a022-d0b9a5dabb47",
  "occurredOn": 1763355987615,
  "occurredOnTimeZone": 1763355987615
}
```
...
- [Download Avro Schema](./PooledProductCompletedEvent.avsc) - Complete Avro schema definition
