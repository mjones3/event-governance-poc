...
name: Created
version: '1.0'
summary: Event published by labeling service when created occurs
owners:
  - labeling-service
producers:
  - labeling-service
...
```json
{
  "eventId": "82204339-4c6a-456b-8163-5212b3fa3cdd",
  "occurredOn": 1763355987222,
  "occurredOnTimeZone": 1763355987222,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./CreatedEvent.avsc) - Complete Avro schema definition
