...
name: Labeled
version: '1.0'
summary: Event published by labeling service when labeled occurs
owners:
  - labeling-service
producers:
  - labeling-service
...
**Schema ID**: 38
**Schema Version**: 1
**Subject**: LabeledEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.labeling.domain.event
...
```json
{
  "eventId": "3ccc5b50-f67f-4ce8-82b4-b1680ef231c5",
  "occurredOn": 1763355987418,
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./LabeledEvent.avsc) - Complete Avro schema definition
