...
name: UserCreated
version: '1.0'
summary: Event published by role service when usercreated occurs
owners:
  - role-service
producers:
  - role-service
...
```json
{
  "eventId": "e7c54fd1-997f-49c8-a9c8-af235f955d3b",
  "occurredOn": 1763348547562,
  "occurredOnTimeZone": 1763348547562,
  "eventVersion": "1.0"
}
```
