...
version: '1.0'
summary: Event published by eventmanagement service when quarantine product occurs
owners:
...
**Schema ID**: 116
**Schema Version**: 5
**Subject**: QuarantineProductEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.apheresisrbc.domain.event

## Business Context

Event published when quarantine product occurs
...
```json
{
  "eventId": "0ebff735-73a0-48c5-82f6-9e79a80d56da",
  "occurredOn": 1763355987818,
  "eventType": "STANDARD"
}
```
...
- [Download Avro Schema](./QuarantineProductEvent.avsc) - Complete Avro schema definition
