...
name: ApheresisPlateletQCRequested
version: '1.0'
summary: Event published by apheresisplatelet service when apheresis platelet qc requested occurs
owners:
...
**Schema ID**: 100
**Schema Version**: 2
**Subject**: ApheresisPlateletQCRequestedEvent
**Domain**: Manufacturing
**Namespace**: com.arcone.biopro.manufacturing.apheresisplatelet.domain.event

## Business Context

Event published when apheresis platelet qc requested occurs
...
```json
{
  "eventId": "19481f4a-3b49-498c-9de0-622031b14cf1",
  "occurredOn": 1763355986829,
  "occurredOnTimeZone": 1763355986829,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
...
- [Download Avro Schema](./ApheresisPlateletQCRequestedEvent.avsc) - Complete Avro schema definition
