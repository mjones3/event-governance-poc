...
name: TestResultExceptionCreated
version: '1.0'
summary: Event published by testresultmanagement service when testresultexceptioncreated occurs
owners:
...
**Schema ID**: 86
**Schema Version**: 1
**Subject**: TestResultExceptionCreatedEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when testresultexceptioncreated occurs
...
```json
{
  "eventId": "760e6756-2386-4ade-9316-11c9c981da61",
  "occurredOn": 1763355987993,
  "occurredOnTimeZone": 1763355987993,
  "eventType": "STANDARD",
  "eventVersion": "1.0",
...
- [Download Avro Schema](./TestResultExceptionCreatedEvent.avsc) - Complete Avro schema definition
