...
version: '1.0'
summary: Event published by recoveredplasmashipping service when recoveredplasmacartonremoved occurs
owners:
...
```json
{
  "eventId": "f9ea3474-4b85-475a-bcad-76b2b9b00583",
  "occurredOn": 1763348547414,
  "occurredOnTimeZone": 1763348547414,
  "eventType": "STANDARD",
  "eventVersion": "1.0"
}
```
