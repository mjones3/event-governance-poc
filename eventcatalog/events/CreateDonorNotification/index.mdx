...
name: CreateDonorNotification
version: '1.0'
summary: Event published by testresultmanagement service when createdonornotification occurs
owners:
...
**Schema ID**: 81
**Schema Version**: 1
**Subject**: CreateDonorNotificationEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when createdonornotification occurs
...
```json
{
  "eventId": "8fbb21c8-e781-40ba-93eb-74e523afa553",
  "occurredOn": 1763355987202,
  "occurredOnTimeZone": 1763355987202,
  "eventType": "STANDARD",
  "eventVersion": "1.0",
...
- [Download Avro Schema](./CreateDonorNotificationEvent.avsc) - Complete Avro schema definition
