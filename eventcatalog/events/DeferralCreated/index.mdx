---
id: DeferralCreated
name: DeferralCreated
version: '1.0'
summary: Event published by testresultmanagement service when deferralcreated occurs
owners:
...
**Schema ID**: 82
**Schema Version**: 1
**Subject**: DeferralCreatedEvent
**Domain**: Unknown
**Namespace**: com.arcone.biopro.donor.testresultmanagement.domain.event

## Business Context

Event published when deferralcreated occurs
...
```json
{
  "eventId": "70107555-bef2-402b-a643-d11e826b6f0f",
  "occurredOn": 1763355987242,
  "occurredOnTimeZone": 1763355987242,
...
- [Download Avro Schema](./DeferralCreatedEvent.avsc) - Complete Avro schema definition
