...
name: Modified
version: '1.0'
summary: Event published by labeling service when modified occurs
owners:
  - labeling-service
producers:
  - labeling-service
...
```json
{
  "eventId": "5b06f49a-f677-4cc9-9a54-a37967aa3644",
  "occurredOn": 1763355987442,
  "occurredOnTimeZone": 1763355987442
}
```
...
- [Download Avro Schema](./ModifiedEvent.avsc) - Complete Avro schema definition
